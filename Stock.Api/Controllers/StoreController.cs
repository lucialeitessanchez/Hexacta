...
namespace Stock.Api.Controllers
{
    ...
    [Route("api/store")] //ruta que va a exponer el servicio
    [ApiController]
    public class StoreController : ControllerBase
    {
        ...
        public ActionResult Post([FromBody] StoreDTO value)
        {
            ...
            try
            {
                ...
                value.Id = store.Id;
                return Ok(new { Success = true, Message = "", data = value }); //termina siendo un json en mi response
            }
            catch
            {
        ...
        [HttpPost("search")]  //la ruta del controlador/search (para entrar) 
